...
<section id="home" class="welcome-hero">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
                        <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                            ...
                            <li class="scroll"><a href="#service">Add now</a></li>
    ...
    <div class="container">
        <div class="welcome-hero-txt">
            <h2>ADD YOUR DREAM CAR TO CARVILLA</h2>

            <button class="welcome-btn" onclick="window.location.href='#service'">Add now</button>
        </div>
    </div>
